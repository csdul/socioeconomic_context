...
drop_keywords = []                # remove private limousine transportation
keyword_drop_codes = []  # SIC codes of points to drop keywords from 
code_type = 'SIC'

# output naming conventions are based on EPOI year
epoi_year = 2017
out_dir = f'C:/Users/Sean/Documents/CSDUL/Data/counts_expanded_ccnsr/{epoi_year}'
out_csv = f'{out_dir}/2011_ct_{epoi_year}_epoi_ccnsr_expanded.csv'
...
sic_codes = [80620000, 81110000, 83610000, 83990000, 86410000, 
             58130000, 59210000, 61410000, 70110000, 70210000, 72150000]                                # Religion and Culture
